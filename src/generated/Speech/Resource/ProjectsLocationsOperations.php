 ...
 *  </code>
 */
class ProjectsLocationsOperations extends Resource
{
  /**
  ...
  public function get($name, $optParams = array())
  {
    ...
    return $this->call('get', [$params], Model\Operation::class);
  }
   ...
   * @return Model\ListOperationsResponse
   */
  public function listProjectsLocationsOperations($name, $optParams = array())
  {
    $params = ['name' => $name];
    $params = array_merge($params, $optParams);
    return $this->call('list', [$params], Model\ListOperationsResponse::class);
  }
}
